        ...
        <div className="courseContainer">
            {
                <Card sx={{ maxWidth: "100%" }}>
                    <CardContent>
                        <Typography sx={{ my: "20px" }} gutterBottom variant="h5" component="div">Matematica</Typography>
                            ...
                            <Table sx={{ minWidth: "50%" }} aria-label="spanning table">
                                <TableBody>
                                    ...
                                    <TableRow key={1 + "infos"}>
                                        ...
                                        <Typography className="sizedText" fontSize="13px">Diverse informatii</Typography>
                                    ...
                                    <TableRow key={1 + "requirements"}>
                                        ...
                                        <TableCell align="center" sx={{ width: "50%" }}>
                                            <Typography className="sizedText" fontSize="13px">Matematica primara, clasele 5-8</Typography>
                                        </TableCell>
                                    </TableRow>
                                </TableBody>
                            </Table>
